...
def main():
    ...
    figures_data = [
        ...
        ["", "3.1 (9A) Client & CDN Layer (Frontend)", "20"],
        ["", "3.2 (9B) Application Layer (Backend)", "21"],
        ["", "3.3 (9C) Data & External Services Layer", "22"],
        ["4", "System Workflows (Section 2.4)", ""],
        ["", "4.1 (10A) User Journey Part 1 (Steps 1-3)", "22"],
        ["", "4.2 (10B) User Journey Part 2 (Steps 4-5)", "23"],
        ["5", "Technical Stack (Section 3.1)", ""],
        ["", "5.1 (11) Technology Stack Overview", "23"],
        ["6", "Software Architecture (Section 3.2)", ""],
        ["", "6.1 (12A) Tier 1 - Presentation Layer (Frontend)", "25"],
        ["", "6.2 (12B) Tier 2 - Application Layer (Backend)", "25"],
        ["", "6.3 (12C) Tier 3 - Data Layer (Database)", "26"],
        ["7", "Database & Real-Time Features", ""],
        ["", "7.1 (13) Database Schema (ER Diagram)", "26"],
        ["", "7.2 (14) Match Applications UI", "28"],
        ["", "7.3 (15) Voice Channels Interface", "29"],
        ["", "7.4 (16) WebSocket Communication Flow", "30"],
        ["8", "Deployment Architecture (Section 4)", ""],
        ["", "8.1 (17A) Global CDN Layer (Vercel)", "32"],
        ["", "8.2 (17B) Application Layer (Railway)", "33"],
        ["", "8.3 (17C) Data Layer (Neon PostgreSQL)", "34"],
        ["", "8.4 (17D) External Services", "34"],
    ]
    ...
    tables_data = [
        ...
        ["4", "Technology Stack Details", "24"],
        ["5", "Database Tables Summary", "27"],
        ["6", "System Performance Metrics", "35"],
        ["7", "Frontend Performance Metrics", "36"],
        ["8", "Feature Implementation Status", "37"],
        ["9", "Current Infrastructure Costs", "37"],
    ]
    ...
    toc_data = [
        ...
        ["", "2.4 System Workflow", "22"],
        ["3", "System Implementation & Technical Details", "23"],
        ["", "3.1 Technical Stack", "23"],
        ["", "3.2 System Architecture", "25"],
        ["", "3.3 Database Schema", "26"],
        ["", "3.4 Key Components & Features", "28"],
        ["", "3.5 API Architecture", "29"],
        ["", "3.6 Real-Time Communication", "30"],
        ["4", "Deployment and Infrastructure", "32"],
        ["", "4.1 Deployment Architecture", "32"],
        ["", "4.2 Scalability & Security", "35"],
        ["5", "Results & Discussion", "35"],
        ["", "5.1 Backend Performance", "35"],
        ["", "5.2 Frontend Performance", "36"],
        ["", "5.3 Feature Implementation Summary", "37"],
        ["", "5.4 Infrastructure Costs", "37"],
        ["", "5.5 Summary", "38"],
        ["6", "Conclusion & Future Works", "39"],
        ["", "6.1 Key Achievements", "39"],
        ["", "6.2 Challenges & Solutions", "39"],
        ["", "6.3 Future Enhancements", "39"],
        ["7", "References", "40"],
        ["8", "Appendix", "41"],
        ["", "A. GitHub Repository & Deployment Links", "41"],
        ["", "B. Project Structure", "41"],
        ["", "C. Environment Variables & Configuration", "41"],
        ["", "D. Setup & Installation Guide", "42"],
    ]

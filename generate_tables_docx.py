...
def main():
    ...
    figures_data = [
        ...
        ["", "3.2 (9B) Application Layer (Backend)", "20"],
        ["", "3.3 (9C) Data & External Services Layer", "21"],
        ["4", "System Workflows", ""],
        ...
        ["", "7.1 (13) Database Schema (ER Diagram)", "24"],
    ...
    tables_data = [
        ...
        ["4", "Technology Stack Details", "22"],
        ["5", "Database Tables Summary", "25"],
        ["6", "System Performance Metrics", "31"],
        ["7", "Frontend Performance Metrics", "32"],
        ["8", "Feature Implementation Status", "33"],
        ["9", "Current Infrastructure Costs", "33"],
    ]
    ...
    toc_data = [
        ...
        ["", "2.4 System Workflow", "21"],
        ["3", "System Implementation & Technical Details", "22"],
        ["", "3.1 Technical Stack", "22"],
        ["", "3.2 System Architecture", "23"],
        ["", "3.3 Database Schema", "24"],
        ["", "3.4 Key Components & Features", "25"],
        ["", "3.5 API Architecture", "27"],
        ["", "3.6 Real-Time Communication", "28"],
        ["4", "Deployment and Infrastructure", "29"],
        ["", "4.1 Deployment Architecture", "29"],
        ["", "4.2 Scalability & Security", "31"],
        ["5", "Results & Discussion", "31"],
        ["", "5.1 Backend Performance", "31"],
        ["", "5.2 Frontend Performance", "32"],
        ["", "5.3 Feature Implementation Summary", "33"],
        ["", "5.4 Infrastructure Costs", "33"],
        ["", "5.5 Summary", "33"],
        ["6", "Conclusion & Future Works", "34"],
        ["", "6.1 Key Achievements", "34"],
        ["", "6.2 Challenges & Solutions", "34"],
        ["", "6.3 Future Enhancements", "34"],
        ["7", "References", "35"],
        ["8", "Appendix", "36"],
        ["", "A. GitHub Repository & Deployment Links", "36"],
        ["", "B. Project Structure", "36"],
        ["", "C. Environment Variables & Configuration", "36"],
        ["", "D. Setup & Installation Guide", "37"],
    ]

...
## APPENDIX: SPLIT DIAGRAMS FOR IMAGE GENERATION

The following diagrams are split versions of the consolidated architecture diagrams, designed for easier image generation without congestion.

---

### THREE-TIER ARCHITECTURE - SPLIT INTO 3 DIAGRAMS
...
║   │   │  • Matches       │  │  • VoiceChat     │  │  • ws.ts         │        │  ║
║   │   │  • Profile       │  │  • UserCard      │  │  • firebase.ts   │        │  ║
║   │   │  • Discover      │  │  • Navbar        │  │  • query.ts      │        │  ║
║   │   │  • Voice         │  │  • Sidebar       │  │  • auth.ts       │        │  ║
║   │   └──────────────────┘  └──────────────────┘  └──────────────────┘        │  ║
║   │                                                                            │  ║
║   │   ┌────────────────────────────────────────────────────────────────────┐  │  ║
║   │   │                        TECHNOLOGY STACK                             │  │  ║
║   │   │                                                                     │  │  ║
║   │   │   TypeScript    │    Tailwind CSS    │    TanStack Query v5        │  │  ║
║   │   │   Wouter        │    shadcn/ui       │    React Hook Form          │  │  ║
║   │   └────────────────────────────────────────────────────────────────────┘  │  ║
║   │                                                                            │  ║
║   │   Build: Vite 5.4.19                                                      │  ║
║   │   Bundle Size: 450KB gzipped                                              │  ║
...
╠═══════════════════════════════════════════════════════════════════════════════════╣
║                                                                                   ║
║                          Receives from Presentation Layer                         ║
║                          ────────────────────────────────                         ║
║                                       │                                           ║
║                                       ▼                                           ║
║                                                                                   ║
...
║   │                                                                            │  ║
║   │   ┌──────────────────┐  ┌──────────────────┐  ┌──────────────────┐        │  ║
║   │   │   REST Routes    │  │  WebSocket Server│  │    Services      │        │  ║
║   │   │                  │  │                  │  │                  │        │  ║
║   │   │  • /api/auth     │  │  • Broadcast     │  │  • hms-service   │        │  ║
║   │   │  • /api/users    │  │  • Heartbeat     │  │  • r2-storage    │        │  ║
║   │   │  • /api/matches  │  │  • Connection    │  │  • firebase      │        │  ║
║   │   │  • /api/voice    │  │    Management    │  │  • push-notif    │        │  ║
║   │   │  • /api/notifs   │  │                  │  │                  │        │  ║
║   │   └──────────────────┘  └──────────────────┘  └──────────────────┘        │  ║
║   │                                                                            │  ║
║   │   ┌────────────────────────────────────────────────────────────────────┐  │  ║
║   │   │                        TECHNOLOGY STACK                             │  │  ║
║   │   │                                                                     │  │  ║
║   │   │   TypeScript    │    Passport.js    │    Drizzle ORM               │  │  ║
║   │   │   ws Library    │    Firebase Admin │    Express Session           │  │  ║
║   │   └────────────────────────────────────────────────────────────────────┘  │  ║
║   │                                                                            │  ║
...
║   │   │  • name          │  │  • game          │  │  • creator_id    │        │  ║
║   │   │  • avatar_url    │  │  • skill_level   │  │  • status        │        │  ║
║   │   │  • phone         │  │  • description   │  │  • participants  │        │  ║
║   │   │  • is_verified   │  │  • status        │  │  • created_at    │        │  ║
║   │   └──────────────────┘  └──────────────────┘  └──────────────────┘        │  ║
║   │                                                                            │  ║
║   │   ┌──────────────────┐  ┌──────────────────┐  ┌──────────────────┐        │  ║
║   │   │  user_connections│  │ user_game_profiles│ │   notifications  │        │  ║
║   │   │                  │  │                  │  │                  │        │  ║
║   │   │  • id (PK)       │  │  • id (PK)       │  │  • id (PK)       │        │  ║
║   │   │  • user_id (FK)  │  │  • user_id (FK)  │  │  • user_id (FK)  │        │  ║
║   │   │  • connected_id  │  │  • game_id (FK)  │  │  • type          │        │  ║
║   │   │  • status        │  │  • rank          │  │  • message       │        │  ║
║   │   │  • created_at    │  │  • wins/losses   │  │  • is_read       │        │  ║
║   │   └──────────────────┘  └──────────────────┘  └──────────────────┘        │  ║
║   │                                                                            │  ║
║   │   ┌────────────────────────────────────────────────────────────────────┐  │  ║
║   │   │                         FEATURES                                    │  │  ║
║   │   │                                                                     │  │  ║
║   │   │   Auto-scaling        │    Connection Pooling (pgbouncer)          │  │  ║
║   │   │   PITR Backups        │    99.9% Uptime                            │  │  ║
║   │   │   <50ms Query Time    │    Read Replicas Available                 │  │  ║
║   │   └────────────────────────────────────────────────────────────────────┘  │  ║
║   └───────────────────────────────────────────────────────────────────────────┘  ║
║                                                                                   ║
╚═══════════════════════════════════════════════════════════════════════════════════╝
...
### DEPLOYMENT ARCHITECTURE - SPLIT INTO 4 DIAGRAMS
...
║   │                                                                            │  ║
║   │   🚀 Auto Deploy:      Connected to GitHub main branch                     │  ║
║   │   ❤️ Health Check:     /health endpoint every 30 seconds                   │  ║
║   │   🔄 Restart Policy:   Automatic on failure                                │  ║
║   │   📊 Startup Time:     < 5 seconds                                         │  ║
║   └───────────────────────────────────────────────────────────────────────────┘  ║
║                                                                                   ║
║                                       │                                           ║
║                                       ▼                                           ║
║                          PostgreSQL Wire Protocol → Data Layer                    ║
║                                                                                   ║
╚═══════════════════════════════════════════════════════════════════════════════════╝
```
...
║   │   │                         CORE TABLES                                 │  │  ║
║   │   │                                                                     │  │  ║
║   │   │   users  │  match_requests  │  voice_channels  │  notifications    │  │  ║
║   │   │   user_connections  │  user_game_profiles  │  games                │  │  ║
║   │   └────────────────────────────────────────────────────────────────────┘  │  ║
║   └───────────────────────────────────────────────────────────────────────────┘  ║
║                                                                                   ║
╚═══════════════════════════════════════════════════════════════════════════════════╝
...
║   │   │                              │  │                              │      │  ║
║   │   │   • Phone OTP (SMS)          │  │   • OAuth 2.0                │      │  ║
║   │   │   • ID Token Verification    │  │   • Social Login             │      │  ║
║   │   │   • Auth SDK                 │  │   • Profile Data             │      │  ║
║   │   │   • Free: 10 SMS/day         │  │   • Free: Unlimited          │      │  ║
║   │   └──────────────────────────────┘  └──────────────────────────────┘      │  ║
║   └───────────────────────────────────────────────────────────────────────────┘  ║
║                                                                                   ║
║   ┌───────────────────────────────────────────────────────────────────────────┐  ║
...
║   │                                                                            │  ║
║   │   ┌──────────────────────────────┐  ┌──────────────────────────────┐      │  ║
║   │   │         🎤 100MS              │  │     ☁️ CLOUDFLARE R2          │      │  ║
║   │   │                              │  │                              │      │  ║
║   │   │   • Voice/Video Rooms        │  │   • S3-Compatible Storage    │      │  ║
║   │   │   • WebRTC SFU               │  │   • Profile Images           │      │  ║
║   │   │   • Recording (optional)     │  │   • Free Egress (CDN)        │      │  ║
║   │   │   • Free: 10K minutes/mo     │  │   • Free: 10GB storage       │      │  ║
║   │   └──────────────────────────────┘  └──────────────────────────────┘      │  ║
║   └───────────────────────────────────────────────────────────────────────────┘  ║
║                                                                                   ║
║   ┌───────────────────────────────────────────────────────────────────────────┐  ║
